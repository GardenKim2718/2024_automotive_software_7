...
sleep 3
terminator -e "bash -c 'source ~/.bashrc && source install/setup.bash && ros2 launch autonomous_driving autonomous_driving.launch.xml; echo \"Press Enter to close the terminal...\"; read'"